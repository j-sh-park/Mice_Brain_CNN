...
```{r}
cluster_A_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_1_power", full.names = TRUE)

cluster_B_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_2_power", full.names = TRUE)

cluster_C_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_3_power", full.names = TRUE)

cluster_D_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_4_power", full.names = TRUE)

cluster_E_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_5_power", full.names = TRUE)

cluster_F_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_6_power", full.names = TRUE)

cluster_G_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_7_power", full.names = TRUE)

cluster_H_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_8_power", full.names = TRUE)

cluster_I_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_9_power", full.names = TRUE)

cluster_J_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_10_power", full.names = TRUE)

cluster_K_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_11_power", full.names = TRUE)

cluster_L_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_12_power", full.names = TRUE)

cluster_M_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_13_power", full.names = TRUE)

cluster_N_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_14_power", full.names = TRUE)

cluster_O_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_15_power", full.names = TRUE)

cluster_P_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_16_power", full.names = TRUE)

cluster_Q_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_17_power", full.names = TRUE)

cluster_R_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_18_power", full.names = TRUE)

cluster_S_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_19_power", full.names = TRUE)

cluster_T_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_20_power", full.names = TRUE)

cluster_U_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_21_power", full.names = TRUE)

cluster_V_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_22_power", full.names = TRUE)

cluster_W_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_23_power", full.names = TRUE)

cluster_X_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_24_power", full.names = TRUE)

cluster_Y_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_25_power", full.names = TRUE)

cluster_Z_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_26_power", full.names = TRUE)

cluster_ZA_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_27_power", full.names = TRUE)

cluster_ZB_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_28_power", full.names = TRUE)
