...
```{r}
cluster_A_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_1", full.names = TRUE)

cluster_B_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_2", full.names = TRUE)

cluster_C_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_3", full.names = TRUE)

cluster_D_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_4", full.names = TRUE)

cluster_E_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_5", full.names = TRUE)

cluster_F_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_6", full.names = TRUE)

cluster_G_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_7", full.names = TRUE)

cluster_H_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_8", full.names = TRUE)

cluster_I_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_9", full.names = TRUE)

cluster_J_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_10", full.names = TRUE)

cluster_K_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_11", full.names = TRUE)

cluster_L_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_12", full.names = TRUE)

cluster_M_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_13", full.names = TRUE)

cluster_N_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_14", full.names = TRUE)

cluster_O_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_15", full.names = TRUE)

cluster_P_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_16", full.names = TRUE)

cluster_Q_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_17", full.names = TRUE)

cluster_R_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_18", full.names = TRUE)

cluster_S_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_19", full.names = TRUE)

cluster_T_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_20", full.names = TRUE)

cluster_U_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_21", full.names = TRUE)

cluster_V_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_22", full.names = TRUE)

cluster_W_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_23", full.names = TRUE)

cluster_X_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_24", full.names = TRUE)

cluster_Y_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_25", full.names = TRUE)

cluster_Z_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_26", full.names = TRUE)

cluster_ZA_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_27", full.names = TRUE)

cluster_ZB_files = list.files("Biotechnology_small/data_processed/cell_images/cluster_28", full.names = TRUE)
